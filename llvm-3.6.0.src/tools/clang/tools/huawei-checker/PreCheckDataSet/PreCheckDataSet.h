#ifndef PRE_CHECK_DATA_H
#define PRE_CHECK_DATA_H
...
public:
  ...
  vector<string> &getLocation() { return this->location; }
};
...
private:
  ...
  void collect_missing_check_data(ASTFunction *caller, CallExpr *MemOPcallExpr,
                                  FunctionDecl *callee, int label);
};
}
