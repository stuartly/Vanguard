                                              ...
                                              gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__POINTER_POINTER_OBJECT) (gpointer     data1,
                                                             ...
                                                             gpointer     arg_3,
                                                             gpointer     data2);
  GMarshalFunc_VOID__POINTER_POINTER_OBJECT callback;
                                            ...
                                            gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_STRING_DOUBLE) (gpointer     data1,
                                                           ...
                                                           gdouble      arg_3,
                                                           gpointer     data2);
  GMarshalFunc_VOID__STRING_STRING_DOUBLE callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                          ...
                                          gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__ENUM_STRING_STRING) (gpointer     data1,
                                                         ...
                                                         gpointer     arg_3,
                                                         gpointer     data2);
  GMarshalFunc_VOID__ENUM_STRING_STRING callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                  ...
                                                  gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__ENUM_STRING_STRING_BOOLEAN) (gpointer     data1,
                                                                 ...
                                                                 gboolean     arg_4,
                                                                 gpointer     data2);
  GMarshalFunc_VOID__ENUM_STRING_STRING_BOOLEAN callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                   ...
                                                   gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_STRING_OBJECT_OBJECT) (gpointer     data1,
                                                                  ...
                                                                  gpointer     arg_4,
                                                                  gpointer     data2);
  GMarshalFunc_VOID__STRING_STRING_OBJECT_OBJECT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
                                                     ...
                                                     gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__POINTER_POINTER_OBJECT_OBJECT) (gpointer     data1,
                                                                    ...
                                                                    gpointer     arg_4,
                                                                    gpointer     data2);
  GMarshalFunc_VOID__POINTER_POINTER_OBJECT_OBJECT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
